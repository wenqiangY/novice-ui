    ...
    return {
      ...
      ...i18n({
        'zh-CN': {
          start: '开始使用',
          intro1: '一个 Vue 3 组件库',
          intro2: '基于 Naive UI 二次封装，比较完整，主题可调，使用 TypeScript，不算太慢',
          intro3: '有点意思',
          intro4: '换个主题'
        },
        'en-US': {
          ...
          intro2:
            'Secondary packaging based on naive UI, Fairly Complete, Customizable Themes, Uses TypeScript, Not Too Slow',
